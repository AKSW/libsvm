...
abstract class Kernel extends QMatrix {
    ...
    // FIXME: made attributes private --> check if everything still works
    private static Map<String, Integer> class2id;
    private static Map<Integer, String> id2class;
    private static final String graph_uri_str = "http://phenomebrowser.net/smltest/";
    private static URIFactory factory = URIFactoryMemory.getSingleton();
    private static URI graph_uri = factory.getURI(graph_uri_str);
    ...
    private static double evalSim(svm_node[] x, svm_node[] y) {
    ...
    Kernel(int l, svm_node[][] x_, svm_parameter param)
    {
        ...
        // <semkernel specific>
        class2id = param.class2id;

        id2class = new HashMap<Integer, String>();
        for (String cls : class2id.keySet()) {
            int ind = class2id.get(cls);
            id2class.put(ind, cls);
        }
        // </semkernel specific>
        ...
        for(i=0;i<nr_fold;i++)
        {
                ...
                param.svm_type == svm_parameter.NU_SVC))
            {
                ...
                for(j=begin;j<end;j++) {
                    ...
                    // FIXME: use logging instead (if possible)
